...
export default function Purchase() {
  ...
  return (
    <section
      id="vasarlas"
      className="relative bg-coral px-6 py-20 lg:px-8 lg:py-28 overflow-hidden"
    >
      {/* Gradient glow */}
        ...
        >
          ...
          <ul className="space-y-3 text-left mb-8">
            {[
              ...
              <li
                key={idx}
                className="flex items-center gap-3 font-inter text-white/90 text-sm"
              >
                <span className="flex-shrink-0 w-5 h-5 rounded-full bg-white/30 flex items-center justify-center text-white text-xs">
                  ✓
                </span>
                {item}
              </li>
